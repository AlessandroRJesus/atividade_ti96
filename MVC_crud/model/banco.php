...
class Banco
{
    ...
    {
        $stmt = $this -> mysqli -> preparo("INSERT *FROM livros('nome','autor', 'quantidade','preco','data') value(?,?,?,?,?)");
    ...
    {
        $stmt =$this->mysqli->prepare("UPDATE 'livros' SET 'nome'= ?, 'autor'= ?,
        'quantidade'=?, 'flag'=?, 'data'= ? WHERE 'nome' =?");
